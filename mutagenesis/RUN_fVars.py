...
def runAll(iteration, exclusions, out_dir, num_affected, cutoff_score, n, k1, k2, exclude):
	...
	log_file = open("/Users/Chris/GitHub/thesis/mutagenesis/run_n2_k2_v_na/log.txt", 'a')
...
log_file = open("/Users/Chris/GitHub/thesis/mutagenesis/run_n2_k2_v_na/log.txt", 'w')
...
while iteration < 5:
	...
	final_resis, excludeMutations = runAll(iteration=iteration, exclusions=exclusions,
		out_dir="/Users/Chris/GitHub/thesis/mutagenesis/run_n2_k2_v_na/", 
	...
	out = open("/Users/Chris/GitHub/thesis/mutagenesis/run_n2_k2_v_na/"+str(iteration)+"_remaining.txt", 'w')
