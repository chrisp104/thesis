...
def runAll(iteration, exclusions, out_dir, num_affected, cutoff_score, n, k1, k2, exclude):
	...
	log_file = open("/Users/Chris/GitHub/thesis/mutagenesis/run_sep_n2_k3_v_na/log.txt", 'a')
	if not os.path.exists(out_dir):
		os.makedirs(out_dir)

	# ************* RUN RANKER ************

	for directory in os.listdir("/Users/Chris/GitHub/thesis/mutagenesis/sep_mutations"):
		if directory[0] != 'D': continue
		os.chdir("/Users/Chris/GitHub/thesis/mutagenesis/sep_mutations/"+directory)
		for model in os.listdir("."):
			if model[0] != 'n': continue
			os.chdir("/Users/Chris/GitHub/thesis/mutagenesis/sep_models/"+directory+"/"+model)
			rankForAb("/Users/Chris/GitHub/thesis/mutagenesis/sep_mutations/"+directory+'/'+model+'/',
				out_dir+str(iteration)+'_'+"ranked_mutations/"+directory+model+".txt",
				num_affected, cutoff_score, exclusions)

	rankForAll("/Users/Chris/GitHub/thesis/mutagenesis/sep_mutations/",
...
log_file = open("/Users/Chris/GitHub/thesis/mutagenesis/run_sep_n2_k3_v_na/log.txt", 'w')
...
while iteration < 5:
	...
	final_resis, excludeMutations = runAll(iteration=iteration, exclusions=exclusions,
		out_dir="/Users/Chris/GitHub/thesis/mutagenesis/run_sep_n2_k3_v_na/", 
	...
	out = open("/Users/Chris/GitHub/thesis/mutagenesis/run_sep_n2_k3_v_na/"+str(iteration)+"_remaining.txt", 'w')
