...
def contacts(pdb, ag, dist):
	...
	# instantiate the three chains of isdb
	return_chain_num['O'] = 0
	return_chain_num['R'] = 0
	return_chain_num['T'] = 0
...
def writeContacts(file_name, numbers, residues, chain_nums):
...
numbers, residues, chain_nums = contacts("example.pdb", ['O', 'R', 'T'], 8)
writeContacts("example_out", numbers, residues, chain_nums)
