## rmsd.py
## calculates the rmsd of the ligand for each docking model to crystal structure
## FILES

# Crystal structure file
crystal_file = open('5d1x_aligned.pdb', 'r')
...
for c_line in crystal:
	if c_line[0:3] == "": break
	if (c_line[21] == 'E' and c_line[0:4] == "ATOM"):
...
for key in models:
	...
	for m_line in model:
		if m_line[0:3] == "": break
		if (m_line[21] == 'E' and m_line[0:4] == "ATOM"):
